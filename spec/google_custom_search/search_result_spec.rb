...
describe GoogleCustomSearch::SearchResult do
  ...
  RESULTS_JSON_NO_RESULT = {"responseData"=>{"results"=>[],
                  "cursor"=>{"estimatedResultCount"=>"409", "currentPageIndex"=>3},
                  "context"=>{"title"=>"Cultural District Search Engine", "facets"=>[]}}}
